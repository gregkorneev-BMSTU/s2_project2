...
def main():
    ...
    save_image(os.path.join(debug_dir, "lower_clean_mask_soft.png"), lower_clean_mask)
    save_image(os.path.join(debug_dir, "lower_clean_mask_strict.png"), lower_debug["strict_clean_mask"])
    ...
    save_image(os.path.join(debug_dir, "lower_signal_overlay_soft.png"), lower_overlay)
    save_image(os.path.join(debug_dir, "lower_signal_overlay_strict.png"), lower_debug["strict_overlay"])
    ...
    print(f"[INFO] Lower trace coverage strict: {lower_debug['strict_debug']['trace_coverage']:.2f}%")
    print(f"[INFO] Lower trace coverage soft: {lower_debug['trace_coverage']:.2f}%")
    print(f"[INFO] Lower selected mode: {lower_debug['selected_mode']}")
    if lower_debug["trace_coverage"] < 55.0:
        print("[WARN] Lower coverage remains low, check lower_signal_overlay_soft.png")
