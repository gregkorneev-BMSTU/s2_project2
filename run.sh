...
Порядковый номер отсчета, начиная с 0.

Единицы: нет.

### `time_sec`

Время от начала восстановленного фрагмента записи.

Единицы: секунды.

### `fhr_bpm`

Частота сердечных сокращений плода, восстановленная с верхнего графика.

Единицы: ударов в минуту, bpm.

### `ua_kpa`

Маточная активность, восстановленная с нижнего графика.

Единицы: кПа.

### `ua_mmhg`

Маточная активность, пересчитанная из `ua_kpa` в миллиметры ртутного столба.
