...
Демонстрационный слой в `demonstration plots/` читает результаты Python-пайплайна и строит отдельные картинки для быстрой визуальной проверки: восстановленные линии из координат, overlay поверх панелей, общий график откалиброванных временных рядов и сводный summary.
...
│   ├── demonstration_summary.png
│   ├── calibrated_timeseries.png
│   ├── upper_trace_overlay.png
...
После Python-пайплайна и калибровки можно построить проверочные картинки:

```bash
python3 "demonstration plots/make_demonstration_plots.py"
```

Скрипт читает `results/python/` и создает:

- `demonstration plots/upper_trace_from_coordinates.png`
- `demonstration plots/lower_trace_from_coordinates.png`
- `demonstration plots/upper_trace_overlay.png`
- `demonstration plots/lower_trace_overlay.png`
- `demonstration plots/calibrated_timeseries.png`
- `demonstration plots/demonstration_summary.png`
...
Ключевые файлы демонстрационных графиков:

- `demonstration_summary.png` - сводная проверка координат по двум панелям;
- `upper_trace_from_coordinates.png` и `lower_trace_from_coordinates.png` - линии, восстановленные только из координат `x_px,y_px`;
- `upper_trace_overlay.png` и `lower_trace_overlay.png` - координаты поверх исходных панелей;
